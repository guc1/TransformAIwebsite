  ...
  const highlightMetrics = [
    {
      ...
      label: t("metrics.clients.title"),
      value: totals.client.toLocaleString(locale),
      caption: t("metrics.clients.caption", { count: totals.client }),
    },
    {
      key: "staff" as const,
      label: t("metrics.staff.title"),
      value: totals.staff.toLocaleString(locale),
      caption: t("metrics.staff.caption", { count: totals.staff }),
    },
    {
      key: "visitors" as const,
      label: t("metrics.visitors.title"),
      value: visitorOverview.total.toLocaleString(locale),
      caption: t("metrics.visitors.caption", { count: visitorOverview.total }),
    },
    {
      key: "hoursSaved" as const,
      ...
      <div className="container relative z-10 max-w-6xl space-y-14">
        ...
        <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          {highlightMetrics.map((metric) => (
            <div
              key={metric.key}
              className="rounded-2xl border border-white/10 bg-white/[0.06] px-5 py-4 text-white shadow-lg backdrop-blur-xl"
            >
