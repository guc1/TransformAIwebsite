...
export function AnalyticsRequestForm({ onDismiss }: AnalyticsRequestFormProps) {
  ...
  return (
    <div className="relative isolate flex w-full max-w-2xl flex-col overflow-hidden rounded-[32px] border border-white/12 bg-white/[0.04] p-6 shadow-[0_28px_120px_rgba(15,23,42,0.45)] sm:p-8">
      <div
        aria-hidden
