    ...
    return (
      <button
        ...
        className={cn(
          ...
          "hover:shadow-sky-400/25 group-data-[state=open]:shadow-sky-400/30 active:scale-[0.98]",
          className,
        )}
      >
        <span
        ...
        <span
          className={cn(
            ...
            "group-data-[state=open]:bg-gradient-to-r group-data-[state=open]:from-teal-400 group-data-[state=open]:via-sky-500 group-data-[state=open]:to-purple-500",
            "group-data-[state=open]:text-slate-950 group-data-[state=open]:shadow-lg group-data-[state=open]:shadow-sky-500/25",
          )}
        >
          <MessageCircleMore
            aria-hidden
            className="h-4 w-4 text-sky-200 transition duration-300 group-hover:rotate-3 group-data-[state=open]:rotate-3 group-data-[state=open]:text-slate-900"
          />
          {label}
        </span>
      </button>
